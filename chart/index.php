...
<?php 
	...
	$result = mysqli_query($conn, "SELECT Monthname(bulan) as bulan, jumlahPendaftar, jumlahDiterima FROM penerimaan ORDER BY MONTH(bulan) ASC");
	...
	while($res = mysqli_fetch_array($result)) {
		...
		$jumlahPendaftar=$jumlahPendaftar."".$res['jumlahPendaftar'].",";//200,300
...
<head lang="kr">
    ...
    <title>Grafik pertama aku</title>
